...
<form action="PassengerDb.php" method="post" id="route" class="login-form">
    <table border="0" cellpadding="0" cellspacing="3">
        <tr>
            <td>
                <label>Seat</label>
                <input type="number" name="seat" style="width: 300px" required><br><br>
                <label>Source</label>
                <input type="text" name="source" id="txtSource" style="width: 300px" required><br><br>
                <label>Destination</label>
                <input type="text" name="destination" id="txtDestination" style="width: 300px" required><br><br>
